            ...
            {submitted ? (
              ...
              <form onSubmit={handleRSVP} className="relative z-10 space-y-8">
                ...
                <div className="pt-6 space-y-4">
                  ...
                  <a 
                    href="https://www.google.com/calendar/render?action=TEMPLATE&text=Sashika+%26+Dilini+Wedding&dates=20261022T033000Z/20261022T120000Z&details=We+are+excited+to+celebrate+with+you!&location=SKYLOFT+KANDY&sf=true&output=xml" 
                    target="_blank" 
